...
class ContractCar(models.Model):
    ...
    additional_driver_id = fields.Many2one(
        "res.partner", string="Additional Driver", required=False
    )
    # Voucher Car
    ...
    kms_driven = fields.Char(
        string="kMS Driven",
        required=False,
    )
    kms_allowed = fields.Char(
        string="kMS Allowed",
        required=False,
    )
    ex_kms = fields.Char(
    ...
    deposit_ids = fields.One2many(
        comodel_name="deposit.car",
        inverse_name="deposit_id",
        string="",
        required=False,
    )
    # rental
    date_car_in = fields.Datetime(
        string="Date and Time In",
        required=False,
    )
    date_car_out = fields.Datetime(
        string="Date and Time Out",
        required=False,
    )
    car_days = fields.Integer(
        string="Days",
        required=False,
    )
    car_hours = fields.Integer(
        string="Ex Hours",
        required=False,
    )
    car_weeks = fields.Integer(
        string="Weeks AT",
        required=False,
    )
    ex_km = fields.Integer(
        string="EX.KM",
        required=False,
    )
    ...
    inspection_charge = fields.Float(
    ...
    driver_per_day = fields.Float(
        string="Driver Per Day",
        required=False,
    )
    ...
    less_total_deposit = fields.Float(
        string="Less Total Deposit",
        required=False,
    )
